...
build-spark: ## 🐳 Build Spark image
	@docker build -f spark/docker/spark-base/Dockerfile.3.3.0 -t spark-base:latest spark/docker/spark-base
	@docker build -f spark/docker/spark-custom/Dockerfile.3.3.0 -t spark-custom:latest spark/docker/spark-custom

.PHONY: build-operator
build-operator: build-spark ## 🐳 Build Spark Operator image
	@docker build -f spark/docker/spark-operator/Dockerfile.3.3.0 -t spark-operator:latest spark/docker/spark-operator
